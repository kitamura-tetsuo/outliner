...
content = content.replace(/\(window as any\)/g, '(window as Window & typeof globalThis & { __E2E__?: boolean, __E2E_ATTEMPTED_DROP__?: boolean, generalStore?: any, __E2E_LAST_FILES__?: File[], DataTransferItemList?: any, __E2E_DT_ADD_PATCHED__?: boolean, __E2E_DT_ITEMS_GETTER_PATCHED__?: boolean, __E2E_FILE_CTOR_PATCHED__?: boolean, __E2E_DT_CTOR_PATCHED__?: boolean, __E2E_LAST_DROP_EVENT__?: Event, editorStore?: any, File?: any, DataTransfer?: any })');
...
// (event as any)
content = content.replace(/\(event as any\)/g, '(event as unknown as { dataTransfer?: DataTransfer, target?: HTMLElement })');
