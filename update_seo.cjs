...
layout = layout.replace('import { browser } from "$app/environment";', 'import { browser } from "$app/environment";\nimport { SvelteSEO } from "svelte-seo";');
layout = layout.replace('<div data-testid="app-layout">', `<SvelteSEO
