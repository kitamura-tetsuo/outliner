...
const windowAnyReplacement =
    "(window as Window & typeof globalThis & { DEBUG_MODE?: boolean, generalStore?: { currentPage?: { items?: { iterateUnordered?: () => Iterable<unknown> } } }, itemsStore?: unknown, editorStore?: { currentItems?: { id: string, [key: string]: unknown }[] }, appStore?: { currentPage?: unknown }, editorOverlayStore?: unknown })";
