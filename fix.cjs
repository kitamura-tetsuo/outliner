...
content = content.replace('const cfg = existing instanceof Y.Map ? existing : new Y.Map<unknown>();', 'const cfg = (existing instanceof Y.Map ? existing : new Y.Map<unknown>()) as Y.Map<unknown>;');
