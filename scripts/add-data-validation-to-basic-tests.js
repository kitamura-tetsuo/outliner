...
// basicテストディレクトリのパス
const basicTestDir = path.join(__dirname, "../client/e2e/basic");
...
function main() {
    console.log("🔍 Scanning basic test files for data validation...\n");

    const files = fs.readdirSync(basicTestDir)
    ...
    for (const file of files) {
        const filePath = path.join(basicTestDir, file);
