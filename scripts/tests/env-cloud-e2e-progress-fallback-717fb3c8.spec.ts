...
/** @feature ENV-0011
 *  Title   : Cloud e2e progress script fallback
...
test("script falls back to GitHub E2E tests outside cloud environment", () => {
    const content = fs.readFileSync(scriptFile, "utf-8");
    expect(content).toMatch(/CLOUD_ENV_NODE_VERSION/);
