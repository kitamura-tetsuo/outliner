...
try {
    ...
    if (fsStore) {
        globalThis.window.__FIRESTORE_STORE__ ||= fsStore;
        globalThis.__FIRESTORE_STORE__ ||= fsStore;
    }
} catch {
...
try {
    ...
    if (yjsStoreInstance) {
        globalThis.window.__YJS_STORE__ ||= yjsStoreInstance;
        globalThis.__YJS_STORE__ ||= yjsStoreInstance;
    }
} catch {
