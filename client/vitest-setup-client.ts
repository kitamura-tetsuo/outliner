...
try {
    ...
    const fsStore = (mod as unknown).firestoreStore;
    if (fsStore) {
        (globalThis as unknown as { window?: { __FIRESTORE_STORE__?: unknown; }; }).window ||= {
            __FIRESTORE_STORE__: undefined,
        };
        (globalThis as unknown as { window?: unknown; }).window.__FIRESTORE_STORE__ ||= fsStore;
...
try {
    ...
    const yjsStoreInstance = (yjsMod as unknown).yjsStore;
    if (yjsStoreInstance) {
        (globalThis as unknown as { window?: { __YJS_STORE__?: unknown; }; }).window ||= { __YJS_STORE__: undefined };
        (globalThis as unknown as { window?: unknown; }).window.__YJS_STORE__ ||= yjsStoreInstance;
