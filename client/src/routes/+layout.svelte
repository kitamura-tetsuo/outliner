...
// Note: Project and Page initialization is now consolidated in src/routes/[project]/[page]/+layout.svelte
// for robustness and to support sub-routes like /schedule correctly.
...
onMount(async () => {
    ...
    if (browser) {
        ...
        // Route-specific logic is now in sub-layouts
