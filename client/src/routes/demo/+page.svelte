    ...
    <div class="mb-4">
        ...
        <div class="flex items-center justify-between">
            ...
            <button type="button"
                ...
                class="rounded-md px-3 py-1.5 text-sm font-medium text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 {isResetting || isLoading ? 'bg-blue-600 opacity-50 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'}"
            >
