...
// 結果表示関数
function showResult(resultVar: 'clipboard' | 'execCommand' | 'permission' | 'playwright', message: string, isSuccess = true) {
...
<main>
  ...
  <div class="container">
    <div class="test-section">
      ...
      <textarea id="clipboard-text" bind:value={clipboardText} placeholder="ここにコピーするテキストを入力してください"></textarea>
      <div>
        <button on:click={handleClipboardCopy}>コピー</button>
        <button on:click={handleClipboardPaste}>ペースト</button>
      </div>
      <div class="result" class:success={clipboardResult.startsWith('✅')} class:error={clipboardResult.startsWith('❌')}>
        {clipboardResult}
      </div>
    </div>
    ...
    <div class="test-section">
      ...
      <textarea id="execcommand-text" bind:value={execCommandText} placeholder="ここにコピーするテキストを入力してください"></textarea>
      <div>
        <button on:click={handleExecCommandCopy}>コピー</button>
        <button on:click={handleExecCommandPaste}>ペースト</button>
      </div>
      <div class="result" class:success={execCommandResult.startsWith('✅')} class:error={execCommandResult.startsWith('❌')}>
        {execCommandResult}
      </div>
    </div>
    ...
    <div class="test-section">
      ...
      <div class="result" class:success={permissionResult.startsWith('✅')} class:error={permissionResult.startsWith('❌')}>
        {permissionResult}
      </div>
    </div>
    ...
    <div class="test-section">
      ...
      <textarea id="playwright-text" bind:value={playwrightText} placeholder="Playwrightからのテキストがここに表示されます"></textarea>
      <div>
        <button on:click={handlePlaywrightCopy}>コピー</button>
        <button on:click={handlePlaywrightPaste}>ペースト</button>
      </div>
      <div class="result" class:success={playwrightResult.startsWith('✅')} class:error={playwrightResult.startsWith('❌')}>
        {playwrightResult}
      </div>
    </div>
  </div>
