...
import DemoPageView from "./[page]/+page.svelte";
...
const mockPageStore = { params: { project: "demo", page: "TestPage" }, url: new URL("http://localhost/demo/TestPage") };
vi.mock("$app/stores", () => {
    return {
        page: {
...
describe("Demo Page View", () => {
    ...
    it("should render outliner when page is found", async () => {
        ...
        expect(screen.getByText(/This is a public, collaborative demo space/)).toBeInTheDocument();
    });
});
