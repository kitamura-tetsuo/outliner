...
describe("Cursor Integration", () => {
    ...
    beforeEach(() => {
        ...
        (generalStore as typeof generalStore & { currentPage?: Item; }).currentPage = mockParentItem;
    ...
    describe("Cursor Navigation", () => {
        ...
        it("should navigate between items when reaching boundaries", () => {
            ...
            } as unknown as import("../../../schema/yjs-schema").Items;
    ...
    describe("Text Operations", () => {
        ...
        it("should handle line breaks correctly", () => {
            ...
            if (mockItem.parent) {
                (mockItem.parent as typeof mockItem.parent & {
            ...
            expect(
                (mockItem.parent as typeof mockItem.parent & { addNode?: typeof mockParentItem.items.addNode; }).addNode
