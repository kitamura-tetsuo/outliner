...
vi.mock("../../../stores/EditorOverlayStore.svelte", () => {
    const mockStore = {
        ...
        setSelection: vi.fn(), syncTextareaToSelection: vi.fn(),
...
describe("Cursor Integration", () => {
    ...
    describe("Cursor Navigation", () => {
        ...
        it("should navigate between items when reaching boundaries", () => {
            ...
            cursor.moveLeft();
            // The cursor should move to the parent item
            expect(cursor.itemId).toBe("parent-item-1"); // Should move to parent item
