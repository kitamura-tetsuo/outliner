...
export class ScrapboxFormatter {
    ...
    private static getProjectPrefix(): string {
        if (typeof window !== "undefined") {
            const store = (window as Window & typeof globalThis & { appStore?: { project?: import("../schema/app-schema").Project; pages?: { current?: import("../schema/app-schema").Item[] }; pageExists?: (name: string) => boolean; }; }).appStore
