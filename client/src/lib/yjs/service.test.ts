...
describe("yjsService", () => {
    ...
    it("binds project presence to store", () => {
        ...
        (globalThis as unknown).presenceStore = presenceStore;
        ...
        awareness.setLocalStateField("user", null as unknown);
        unbind();
    });
    ...
    it("binds page presence to overlay", () => {
        ...
        (globalThis as unknown).editorOverlayStore = editorOverlayStore;
        ...
        (awareness as unknown).emit("change", [
