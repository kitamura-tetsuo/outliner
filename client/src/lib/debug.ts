        ...
        window.getYjsTreeDebugData = function() {
            ...
            const toPlain = (
                ...
                const children = new Items(
                    project.ydoc as unknown as object,
                    project.tree as unknown as object,
                    item.key,
                );
                return {
                    id: item.id,
                    ...
                    items: [...children].map(child =>
                        toPlain(child as { id: string; text?: { toString: () => string; }; key: string; })
                    ),
                };
            };
            ...
            return {
                ...
                items: [...rootItems].map(item =>
                    toPlain(item as { id: string; text?: { toString: () => string; }; key: string; })
                ),
            };
        };
