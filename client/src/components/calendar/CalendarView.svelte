...
function readSettingsFromMap(): CalendarSettings | undefined {
    ...
    return {
        ...
        groupAxes: Array.isArray(groupAxesValue) ? Array.from(new Set(groupAxesValue)) : (groupAxesValue instanceof Y.Array ? Array.from(new Set(groupAxesValue.toArray())) : []),
        laneOrder: Array.isArray(laneOrderValue) ? Array.from(new Set(laneOrderValue)) : (laneOrderValue instanceof Y.Array ? Array.from(new Set(laneOrderValue.toArray())) : []),
