		...
		<div class="token-info">
			...
			{:else}
				...
				<div class="token-meta">
					<div>
						<strong>発行日時:</strong>
						{tokenInfo.payload.iatFormatted || 'N/A'}
					</div>
					<div>
						<strong>有効期限:</strong>
						{tokenInfo.payload.expFormatted || 'N/A'}
					</div>
				</div>
				<div class="section">
					<h4>テナントID情報</h4>
					<div class="tenant-info">
						<p>
							<strong>環境変数のテナントID:</strong>
							{import.meta.env.VITE_AZURE_TENANT_ID || 'なし'}
						</p>
				...
				<div class="section">
					...
					<div class="tenant-info">
						...
						<p>
							<strong>トークン内のドキュメントID:</strong>
							{tokenInfo.payload.documentId || 'なし'}
						</p>
					</div>
				</div>
				<div class="section">
					...
					<div class="tenant-info">
						...
						<p>
							<strong>トークン内のコンテナID:</strong>
							{tokenInfo.payload.containerId || 'なし'}
						</p>
					</div>
				</div>
			{/if}
