        ...
        setTimeout(() => {
            ...
            requestAnimationFrame(() => {
                ...
                if (
                    ...
                    console.log(
                        `OutlinerBase: Initial focus set on global textarea. Active element is textarea: ${document.activeElement === textarea}`,
                    );
                }
            });
...
<div class="outliner-base" data-testid="outliner-base">
    {#if isTemporary}
        <div
            class="temporary-page-notice bg-amber-100 p-4 mb-6 rounded-lg border-l-4 border-amber-500 shadow-md"
        >
