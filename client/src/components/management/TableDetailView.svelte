<script lang="ts">
    ...
    import TableScheduleReferences from "../schedule/TableScheduleReferences.svelte";
    ...
    let { projectName, tableId: routeTableId }: Props = $props();
...
<main class="w-full h-[calc(100vh-5rem)] max-w-7xl mx-auto px-4 py-8 md:px-8 flex flex-col">
    <div class="mb-4 flex-shrink-0">
        <Breadcrumb items={[
            ...
            { label: "Tables", href: resolvePath(projectTablesPath(projectName)) },
