...
>
    <button type="button" role="menuitem" onclick={() => { handleClose(); onAction('add-item'); }}>
    ...
    <button type="button" role="menuitem" class="delete-btn" onclick={() => { handleClose(); onAction('delete-item'); }}>
    ...
    <button type="button" role="menuitem" onclick={() => { handleClose(); onAction('toggle-vote'); }}>
    ...
    <button type="button" role="menuitem" onclick={() => { handleClose(); onAction('toggle-comments'); }}>
    ...
    <button type="button" role="menuitem" onclick={() => { handleClose(); onAction('toggle-type'); }}>
    ...
    <button type="button" role="menuitem" onclick={() => { handleClose(); onAction('toggle-calendar-type'); }}>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
