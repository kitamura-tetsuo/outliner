    ...
    onMount(() => {
        ...
        if (typeof window !== "undefined") {
            firebaseEmulatorInfo = {
                ...
                // LocalStorageからの値も取得
                localStorage_VITE_USE_FIREBASE_EMULATOR:
                    window.localStorage?.getItem("VITE_USE_FIREBASE_EMULATOR"),
                localStorage_VITE_FIRESTORE_EMULATOR_HOST:
                    window.localStorage?.getItem(
                        "VITE_FIRESTORE_EMULATOR_HOST",
                    ),
                localStorage_VITE_AUTH_EMULATOR_HOST:
                    window.localStorage?.getItem("VITE_AUTH_EMULATOR_HOST"),
            };
        }
