...
test.describe("Format Combination", () => {
    ...
    test("Combination of bold and italic is displayed correctly", async ({ page }) => {
        // Create data with the lines parameter of prepareTestEnvironment
        ...
        // Get the 2nd item (the first item that is not the page title)
    ...
    test("Combination of bold and strikethrough is displayed correctly", async ({ page }) => {
        ...
        // Check the HTML of the 2nd item (the first item that is not the page title)
    ...
    test("Combination of italic and code is displayed correctly", async ({ page }) => {
        // Create data with the lines parameter of prepareTestEnvironment
        await TestHelpers.prepareTestEnvironment(page, test.info(), [
            "This is an [/ italic and `code` combination]",
        ]);
    ...
    test("Combined formats are displayed as plain text in the item with cursor", async ({ page }) => {
        // Create data with the lines parameter of prepareTestEnvironment
        await TestHelpers.prepareTestEnvironment(page, test.info(), [
            "This is [[bold and [/ italic and [-strikethrough] and `code`]]]",
        ]);
