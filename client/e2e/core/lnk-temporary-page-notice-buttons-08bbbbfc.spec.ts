...
/** @feature LNK-0004
 *  Title   : Temporary Page Notification Buttons
 *  Source  : docs/client-features.yaml
 */
import { expect, test } from "@playwright/test";
import { TestHelpers } from "../utils/testHelpers";

test.describe("LNK-0004: Temporary Page Notification Buttons", () => {
    test.beforeEach(async ({ page }, testInfo) => {
        await TestHelpers.prepareTestEnvironment(page, testInfo);
    });

    test("Action buttons in temporary page notification UI function correctly", async ({ page }) => {
        ...
        const createButton = page.locator(".temporary-page-notice button:has-text('Create Page')");
        ...
        const cancelButton = page.locator(".temporary-page-notice button:has-text('Cancel')");
