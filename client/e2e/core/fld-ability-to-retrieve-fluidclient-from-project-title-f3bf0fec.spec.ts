...
/**
 * YJS-0001: Retrieve and verify projects and pages (Yjs)
 *
 * This test verifies that a project can be retrieved from the Yjs-based store,
 * and that a page with a specified title can be created and searched.
 */
test.describe("YJS-0001: Retrieve and verify projects and pages", () => {
    ...
    test("Yjs project exists and page can be created and searched", async ({ page }) => {
    ...
    test("Searching for an empty title is not detected (expected undefined)", async ({ page }) => {
