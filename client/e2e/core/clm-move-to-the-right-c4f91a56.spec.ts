...
test.describe("CLM-0003: Move to the right", () => {
    ...
    test("Cursor moves one character to the right with ArrowRight key", async ({ page }) => {
        ...
        // Press ArrowRight key to move cursor right by one character
    ...
    test("When at the last character, moves to the first character of the next item", async ({ page }) => {
        ...
        // Verify text content of the second item
        ...
        // Verify: Is cursor actually at the end? (Does offset match text length?)
        ...
        console.log(`Re-verify: Offset=${confirmedOffset}, Text Length=${initialText?.length}`);
        ...
        // Re-verify text content of the second item
