...
test.describe("CLM-0003: Move to the right", () => {
    ...
    test("ArrowRight key moves cursor one character to the right", async ({ page }) => {
        ...
        // Move cursor to the start (Home key)
        await page.keyboard.press("Home");
        await page.waitForTimeout(300);

        // Get and verify cursor information again
        ...
        // Verify cursor offset has changed by 1 character (moved right)
    ...
    test("Moves to the first character of the next item when at the last character", async ({ page }) => {
        ...
        // Verify: Is cursor actually at the end (does text length match offset)
        ...
        // Enter text into second item and verify it is input correctly
        await page.keyboard.type("Test input");

        // Verify text content of second item again
