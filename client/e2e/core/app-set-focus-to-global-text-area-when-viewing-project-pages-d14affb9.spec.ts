...
/** @feature APP-0001
 *  Title   : Set focus to global text area when viewing project page
 ...
 * @description Test to verify that focus is automatically set to the global text area when viewing a project page
 * @check Focus is set to global text area when viewing project page
 * @check Cursor is visible
 * @check Text input becomes possible
 */
test.describe("Focus settings when viewing project page", () => {
    ...
    test("Focus is set to global text area when viewing project page", async ({ page }) => {
        ...
        // Verify that the global text area exists
        ...
        // Wait briefly and verify that text has been input
