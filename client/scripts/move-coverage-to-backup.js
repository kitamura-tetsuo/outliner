 ...
 * - Move (not copy) coverage directory to coverage-backups
 ...
 *
 * This script is run at the start of tests to move previous coverage and save disk space.
 */
...
function main() {
    ...
    try {
        // Move coverage directory (move, not copy)
