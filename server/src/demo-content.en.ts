        ...
        pages: [
            ...
            },
            {
                ...
                lines: [
                    ...
                    "Grid metadata, query validation, and trace diagnostics give every represented result column an explicit shown boolean: shown: true means the Grid renders it, while shown: false means the Grid definition intentionally hides it. This applies equally to physical, computed, and joined columns without exposing the persisted sparse hidden setting.",
