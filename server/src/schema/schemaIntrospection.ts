...
export class TableSqlError extends Error { constructor(public kind: string, message: string) { super(message); } }
export const toTableSqlError = (err: any) => err;
export const enqueueWrite = <T>(op: (db: any) => Promise<T>): Promise<T> => { return op({}); };
