...
console.log("Prev of grandchild1:", findPreviousItemRecursive(root, "grandchild1", undefined)?.id);
console.log("Prev of child2:", findPreviousItemRecursive(root, "child2", undefined)?.id);
