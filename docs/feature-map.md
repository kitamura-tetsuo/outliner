...
| SRP-0001 | Project-Wide Search & Replace | client/e2e/new/SRP-0001.spec.ts | implemented |
...
| TST-0005 | Initializing and preparing the test environment | client/e2e/basic.spec.ts<br>client/e2e/basic/add-text-functionality.spec.ts<br>client/e2e/basic/homepage-auth.spec.ts<br>client/e2e/basic/playwright-sanity.spec.ts<br>client/e2e/auth/auth.spec.ts<br>client/e2e/core/port.spec.ts | implemented |
