...
5. Call the intended write tool with `dryRun:true`, `expectedRevision`, and a unique stable `operationId`. Re-read the target to prove the dry run made no change.
